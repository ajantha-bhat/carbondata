 ...
 */
public class InputProcessorStepWithNoConverterImplNoRearrange
  ...
  public InputProcessorStepWithNoConverterImplNoRearrange(CarbonDataLoadConfiguration configuration,
    ...
    for (int i = 0; i < outIterators.length; i++) {
      outIterators[i] =
          new InputProcessorIterator(readerIterators[i], batchSize,
              rowCounter, dataTypes, configuration,
  ...
  private static class InputProcessorIterator extends CarbonIterator<CarbonRowBatch> {
    ...
    public InputProcessorIterator(List<CarbonIterator<Object[]>> inputIterators, int batchSize,
        AtomicLong rowCounter, DataType[] dataTypes, CarbonDataLoadConfiguration configuration,
